...
const Contact = () => {
   ...
   const onSubmit = async (event) => {
    ...
    formData.append("access_key", "6d4fecea-0a66-4ef6-a7d4-e3946698b213");
        ...
        <div className="contact-section">
          <div className="contact-left">
            ...
            <div className="contact-details">
              ...
              <div className="contact-detail">
                <img src={call_icon} alt="" /><p>+90 533 874 4793</p>
              </div>
              <div className="contact-detail">
                <img src={location_icon} alt="" /><p>Lefke, North Cyprus</p>
              </div>
            </div>
          </div>
